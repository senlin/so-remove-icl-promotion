...
If you like the SO Remove ICL Promotion plugin, please consider leaving a [review](http://wordpress.org/support/view/plugin-reviews/so-remove-icl-promotion#postform) or making a [donation](http://so-wp.com/donations/). Thanks!
...
Search for "so remove icl promotion" and install with the **Plugins > Add New** back-end page.
